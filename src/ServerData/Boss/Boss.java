...
//        System.out.println("this status: " + this.bossStatus + " (" + this.id + ")");
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            reward(plKill);
            System.out.println(plKill);
            ServerNotify.gI().notify("Người chơi "+plKill.name + " vừa tiêu diệt được " + this.name + " mọi người đêu ngưỡng mộ");
        }
    ...
    public void wakeupAnotherBossWhenDisappear() {
       System.out.println("Boss " + this.name + " vừa bị tiêu diệt ở " + this.zone.map.mapName + " Khu vực " + this.zone.zoneId);
    }

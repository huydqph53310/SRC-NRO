...
public class BossesData {
    ...
    private static final int[][] FULL_TDHS = new int[][] { { Skill.THAI_DUONG_HA_SAN, 1 },
            ...
            { Skill.THAI_DUONG_HA_SAN, 5 }, { Skill.THAI_DUONG_HA_SAN, 6 }, { Skill.THAI_DUONG_HA_SAN, 7 } };
    ...
    private static final int REST_24_H = 86400000;
       ...
       // **************************************************************************
// Boss bản thân ID = 2
    public static final BossData Ban_than = new BossData(
        "FIDE VÀNG", //name
    ...
    public static final BossData SUPER_BROLY = new BossData(
            ...
            new String[] { "|-1|Gaaaaaaaa!!!" }, // text chat 3
            2_000_000_000, TypeAppear.ANOTHER_LEVEL);
            //******************************************************************** */\
...
public static final BossData SO_4_NM = new BossData(
        ...
        new int[] { 11, 12, 13,33,34, 31,32,10}, // map join
        (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO,FULL_MASENKO), // skill
        new String[] {}, // text chat 1
        new String[] { "|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
                "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
        ...
        new int[] {BossID.SO_3_NM, BossID.SO_2_NM, BossID.SO_1_NM, BossID.TIEU_DOI_TRUONG_NM} // boss join map together
);
    ...
    public static final BossData SIEU_BO_HUNG_1 = new BossData(
            ...
            new String[] {
                    "|-1|Hô hô hô, đây sẽ là kết thúc của lũ ngu ngốc các ngươi!! Ta sẽ chết nhưng sẽ kéo theo cái hành tinh này luôn" }, // text
                                                                                                                                          // chat
                                                                                                                                          // 3
            REST_30_M);
    ...
    public static final BossData SUPER_XEN = new BossData(
            ...
            new int[] { 103 }, // map join
            new int[][] {
                    { Skill.LIEN_HOAN, 1, 300 }, { Skill.LIEN_HOAN, 2, 400 }, { Skill.LIEN_HOAN, 3, 500 },
                    { Skill.LIEN_HOAN, 4, 600 }, { Skill.LIEN_HOAN, 5, 700 }, { Skill.LIEN_HOAN, 6, 800 },
                    { Skill.LIEN_HOAN, 7, 900 },
                    { Skill.KAMEJOKO, 7, 600 }, { Skill.KAMEJOKO, 6, 700 }, { Skill.KAMEJOKO, 5, 800 },
                    { Skill.KAMEJOKO, 4, 900 }, { Skill.KAMEJOKO, 3, 1000 }, { Skill.KAMEJOKO, 2, 1100 },
    ...
    public static final BossData THANZM2 = new BossData(
            ...
            new String[] { "|-1|Ta chính là thế giới",
                    ...
                    "|-1|Ta sẽ đem công lí tới toàn bộ vũ trụ này", "|-2|Ngươi cứ lải nhải hoài 2 chữ công lí vậy?",

...
public class BossID {
    ...
    public static final int FIDE_GOLD = 1;
    public static final int Ban_Than = 2;
    public static final int SO_4_NM = 3;
    public static final int SO_3_NM = 4;
    public static final int SO_2_NM = 5;
    public static final int SO_1_NM = 6;
    public static final int TIEU_DOI_TRUONG_NM = 7;

    public static final int NOEL_NE = -300;
    public static final int BROLY_THUONG = -1269;

    public static final int KUKU = -55;
    public static final int MAP_DAU_DINH = -56;
    public static final int RAMBO = -57;
...
//      
    ...
    public static final int TheHeeters = -224;
    public static final int ELEC = -44;
    public static final int OIL = -45;
    public static final int MACKI = -46;
    public static final int GAS = -47;
...
//    public static final int TAPSU1 = -199;
//    public static final int TAPSU2 = -299;
//    public static final int TAPSU3 = -399;
    public static final int TAPSU4 = -99;

    public static final int MABU = -214;
    public static final int KAMIOREN = -215;
    public static final int BLACK3 = -231;

    //Broly
    public static final int BROLY = -1;
    public static final int BROLY_CLONE = -45;
    public static final int BROLY_SUPER = -46;
...
//    public static final int CUMBERBLACK = -252;
    public static final int CUMBER = -253;
    public static final byte SON_TINH = -6;
    public static final byte ALONG = -124;

...
public class ConstNpc {
   ...
   public static final String HUONG_DAN_HO_TONG = " Gặp Npc Bulma , Chọn đi buôn Rồi Dắt Bé rồng đến Vị Trí được chỉ định \n "
                                     + "Phần quà RanDom 1-5 Xu vàng + 100 điểm, Phí đắt 10k hồng ngọc ..";
    ...
    public static final byte THAN_VU_TRU = 20;
        public static final int MENU_NANG_SKH_LVL = 1004;
           public static final int MENU_PHA_LE_HOA = 1006;
          public static final int MENU_NANG_SKH_TL_LVL = 1005;
    ...
    public static final byte NPC_56 = 56;
    public static final byte YARIROBE = 65;
    public static final byte NOI_BANH = 87;
    public static final byte POPO = 67;
    public static final byte PANCHY = 68;
    public static final byte BuHan = 69;
    public static final byte UNKOWN = 72;
     public static final byte KAMUI = 96;
    public static final byte TORIBOT = 74;
    public static final byte chubedan = 79;
    public static final byte pilap = 80;
    public static final byte tuongred = 81;
    public static final byte mabumap = 82;
    public static final byte THO_REN = 83;
    public static final byte THO_DAI_CA = 84;
    public static final byte MAYGAP = 85;
    public static final byte WHIS_87 = 87;
    public static final byte KHI_DAU_MOI = 95;
    public static final byte TRUNG_LINH_THU = 97;
    public static final byte MONAITO = 102;
    public static final byte MI_NUONG = 18;
    public static final byte MI_NUONGSK = 78;
    public static final byte MABU = 104;
    public static final byte ONGTRUM = 105;
    public static final byte BULMABIP = 86;
    //
    public static final int MINI_GAME = 532;
    public static final int TAIXIU = 533;
    public static final int CHISO_NHANH = 534;
    public static final int CHISO_NHANHPET = 1001;
    public static final int BUFFDHIEU = 538;
    public static final int THAYEVENT = 539;
    //----------------------index menu------------------------------------------
...
public static final int MENU_OPEN_CDRD = 5312;
    public static final int MENU_OPENED_CDRD = 5322;
    public static final int MENU_ACCEPT_GO_TO_CDRD = 5332;
    //index quy lão kamê
    ...
    public static final int MUA_DE = 554;
    public static final int DOIGENDER = 987;
    public static final int DOIGENDER1 = 986;
    public static final int DOIGENDER2 = 985;
    public static final int CONFIRM_MUA_DE_PIC = 555;
    public static final int CONFIRM_MUA_DE_BERUS = 556;
    public static final int CONFIRM_MUA_DE_CUMBER = 991;
    public static final int CONFIRM_MUA_DE_KEFLA = 981;
    public static final int CONFIRM_MUA_DE_GOKU = 982;
    public static final int DOI_SKILL = 563;
    public static final int DOI_SKILL2 = 564;
    public static final int DOI_SKILL3 = 565;
    public static final int DOI_SKILL4 = 566;
    public static final int DOI_VND_SANG_HN = 557;
    public static final int HOC_SKILL = 558;
    public static final int HOC_SKILL_TD = 559;
    public static final int HOC_SKILL_TD1 = 560;
    public static final int HOC_SKILL_TD2= 561;
    public static final int HOC_SKILL_TD3 = 562;
    public static final int HOC_SKILL_TD4 = 609;
    public static final int HOC_SKILL_TD5 = 559;
    public static final int HOC_SKILL_TD6 = 559;
    public static final int HOC_SKILL_TD7 = 559;
    public static final int HOC_SKILL_NM = 560;
    public static final int HOC_SKILL_NM1 = 560;
    public static final int HOC_SKILL_NM2 = 560;
    public static final int HOC_SKILL_NM3 = 560;
    public static final int HOC_SKILL_NM4 = 560;
    public static final int HOC_SKILL_NM5 = 560;
    public static final int HOC_SKILL_NM6 = 560;
    public static final int HOC_SKILL_NM7 = 560;
    public static final int HOC_SKILL_XD = 561;
    public static final int HOC_SKILL_XD1 = 561;
    public static final int HOC_SKILL_XD2 = 561;
    public static final int HOC_SKILL_XD3 = 561;
    public static final int HOC_SKILL_XD4 = 561;
    public static final int HOC_SKILL_XD5 = 561;
    public static final int HOC_SKILL_XD6 = 561;
    public static final int HOC_SKILL_XD7 = 561;
 ...
 //   public static final int MENU_NANG_DOI_SKH_THUONG = 563;
    ...
    public static final int CHUC_NANG_BANG_HOI = 600;
    public static final int CHUC_NANG_BANG_HOI2 = 601;
       public static final int HOI_SKILL = 602;
    public static final int CONFIRM_NHUONG_PC = 511;
    public static final int MENU_ADMIN = 512;
     public static final int MENU_CALL = 13213;
    public static final int BAN_PLAYER = 513;
    public static final int PETSERVICE = 984;
    public static final int MOD = 993;
    public static final int MAUTEN = 969;
    public static final int QUANTRI = 992;
    public static final int QUANTRI1 = 990;
    public static final int ACTIVE = 996;
    public static final int JAIL = 800;
    public static final int NEXTNV = 801;
    public static final int MAKEADMIN = 995;
    public static final int QUANLYTK = 994;
    public static final int QUANLYBOSS = 9944;
    public static final int CALL_BOSS = 999;
    public static final int MENU_PLAYER = 998;
    ...
    public static final int CHECK_DH = 811;
    public static final int RUONG_PHU = 812;
    public static final int BANVANG = 813;
    public static final int TANG_PET = 809;
 ...
 // mùa hè rực rỡ
    public static final int MUAHE = 700;
    public static final int HUNGVUONG = 701;
// Sự Kiện All
    ...
    public static final int menuxd = 521;
      public static final int menutdtl = 51239;
    public static final int menunmtl = 31421;
    public static final int menuxdtl = 3313;
    ...
    public static final int MENU_OPTION_USE_ITEM2006 = 2006;
    public static final int MENU_OPTION_USE_ITEM1105 = 1105;
    public static final int MENU_OPTION_USE_ITEM1498 = 1498;
    public static final int MENU_OPTION_USE_ITEM1499 = 1499;
    public static final int MENU_OPTION_USE_ITEM1500 = 1500;
    public static final int MENU_OPTION_USE_ITEM1501 = 1501;
  public static final int MENU_OPTION_USE_ITEM1502 = 1502;
    ...
    public static final int QUY_DOI_VND = 5099;
      public static final int HOISINH = 12312;
    ...
    //index menu osin
    public static final int MENU_NOT_OPEN_TN = 500;
    public static final int MENU_OPEN_TN = 501;
    public static final int MENU_OPEN_TN2 = 503;
    public static final int MENU_REWARD_TN = 502;
